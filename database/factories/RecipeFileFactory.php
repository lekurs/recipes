...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\RecipeFile>
 */
class RecipeFileFactory extends Factory
{
    /**
     * The name of the factory's corresponding model.
     */
    protected $model = RecipeFile::class;
